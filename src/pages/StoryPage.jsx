      ...
      <Box sx={{ width: { xs: "90%", md: "60%" } }}>
        ...
        >
          <p>
            ...
            hotels to vacation rentals, it seemed impossible to find a place
            that truly felt like home.
          </p>
          <p>
            Frustrated by the limited options and exorbitant prices of
            traditional hotels, worked began exploring alternative options. We
            realized that there were countless hidden gems tucked away in
            differennt locations all arounf the world. Drawing from our own
            experience and a shared passion for innovation, we saw an
            opportunity to create a solution that would benefit both venue
            owners and simple travellers like us.
          </p>
          <p>
          ...
          <p>
            And as the platform grew, so did Emily and Alex's vision for a
            future where finding the perfect holiday home is no longer a
            challenge but an exciting adventure.
          </p>
        </Typography>
      </Box>
    </Box>
